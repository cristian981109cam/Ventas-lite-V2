                        ...
                        <form class="text-left mt-5" action="{{ route('login') }}" method="POST">
                            ...
                            <div class="form" >
                                ...
                                <div id="username-field" class="field-wrapper input">
                                    ...
                                    <input id="email" name="email" type="email" class="form-control @error('email') is-invalid @enderror" placeholder="example.123@example.com" value="{{ old('email') }}" required autocomplete="email" autofocus>
                                    @error('email')
                                ...
                                <div class="field-wrapper">
                                    <button type="submit" class="btn btn-dark btn-block" value="">Acceso</button>
                                </div>
...
<!--
                    ...
                    <p class="terms-conditions text-center">© 2024 All Rights Reserved. <a>KEVIN CALDERON</a> <br>versión 4.2 </p>
